...
import { SENDER_ADDRESS, baseURL, check_msgURL, send_msgURL } from '../../constants'
    ...
    return (
        <div className="chat-container">
            <div style={{ display: "flex", padding: 20, borderBottom: '1px solid var(--light-grey)' }}  >
                ...
                <div>
                    <button style={{ display: 'block', width: '100%', margin: 5 }} onClick={() => { changePanel(); appStorage.setItem('active_receiver', null) }} className='btn-danger' >Logout</button>
